        ...
        <div>
            ...
            <div>
                ...
                <div>
                 ...
                 <div className={`localVideoContainer ${videos.length === 0 ? 'alone' : ''}`}>
                     <video
                 ...
                 {videos.length > 0 && (
                     <div className="remoteVideosContainer">
                          {videos.map((video)=>(
                            <div className="remoteVideoCard" key={video.socketId}> 
                                <video
                                    ...
                                    playsInline
                                />
                                <h2 className="remoteVideoLabel">{video.socketId}</h2> 
                            </div>
                          ))}          
                     </div>
                 )}
